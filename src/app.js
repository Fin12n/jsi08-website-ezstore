...
// Body Parsers — limit set high to handle base64 image data from product forms
...
// Disable cache for all admin routes to prevent outdated rendering
...
const adminVersionsRouter = require('./routes/admin/versions');
...
app.use('/admin/api', isAdmin, adminVersionsRouter);
